  ...
  return <main className={'shell phase-'+phase.toLowerCase()}>
    ...
    <section className="scene">
      <div className="scene-copy">
        {(phase==='CLIENT'||phase==='DECISION'||phase==='RESULT')&&<CharacterCard index={sellerIndex<0?0:sellerIndex} receiver={phase==='RESULT'} phase={phase} itemId={definition.id} t={t}/>}
