  ...
  return <main className={'shell phase-'+phase.toLowerCase()}>
    ...
    <section className="scene">
      ...
      <section className="panel">
        ...
        {phase==='WORKSHOP'&&!item&&<><MetaNav view={metaView} setView={setMetaView} t={t}/>{metaView==='workshop'&&<WorkshopOverview state={state} completedCount={completedCount} itemCount={itemSequence.length} collectionGoal={collectionGoal} t={t}/>} {metaView==='collection'&&<CollectionPanel state={state} t={t}/>} {metaView==='auction'&&<AuctionPanel state={state} t={t}/>} {metaView==='profile'&&<ProfilePanel state={state} xpProgress={xpProgress} t={t}/>}</>}
      </section>
    </section>
